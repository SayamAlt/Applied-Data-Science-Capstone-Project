...
def get_pie_chart(entered_site):
    if (entered_site == 'All Sites' or entered_site == 'None'):
        filtered_df  = spacex_df[spacex_df['class'] == 1] # All Success only for all sites.
        fig = px.pie(
                filtered_df,
                names = 'Launch Site',
        ...
        filtered_df_specific  = spacex_df.loc[spacex_df['Launch Site'] == entered_site]
        fig = px.pie(
                filtered_df_specific,
                names = 'class',
...
def get_scattergraph(entered_site,payload_slider):
    if (entered_site == 'All Sites' or entered_site == 'None'):
        ...
        low, high = payload_slider
        site_specific  = spacex_df.loc[spacex_df['Launch Site'] == entered_site]
